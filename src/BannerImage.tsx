...
function TweenOneG(props: any): ReactElement {
  ...
  return (
    <svg width="482px" height="500px" viewBox="0 0 482 500">
      ...
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" transform="translate(0, 30)">
        <g id="Group-7" transform="translate(140, 244) rotate(-110)">
          <TweenOneG style={{ transformOrigin: '50px 40px' }} animation={animate.rotateY}>
        ...
        <TweenOneG animation={{ ...loop, ...animate.yGroup }}>
          <g id="Group-9" transform="translate(222.000000, 107.000000)">
            <TweenOneG style={{ transformOrigin: '50px 40px' }} animation={animate.rotateR}>
              <image id="cc3" xlinkHref="https://gw.alipayobjects.com/zos/rmsportal/cCmuVrmQIJYlrhFjiPDZ.png" width="160px" height="66px" />
            </TweenOneG>
          </g>
          <g id="Group-9" transform="translate(282.000000, 377.000000) rotate(230)">
            <TweenOneG style={{ transformOrigin: '50px 40px' }} animation={animate.rotateR}>
              <image id="cc3" xlinkHref="https://gw.alipayobjects.com/zos/rmsportal/cCmuVrmQIJYlrhFjiPDZ.png" width="160px" height="66px" />
            </TweenOneG>
          </g>
